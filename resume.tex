...
\cventry{01/2022--03/2023}{Software Engineer}{Husky Robotics}{University of Washington}{Seattle}{
  \begin{compactitem}
    ...
    Redux.
    \begin{compactitem}
      \item Created UI elements for displaying the rover's cameras and telemetry data (position, power, velocity).
...
\cventry{}{MuseShare \href{https://github.com/KyleR56/MuseShare}{\texttt{(GitHub)}}}{}{}{}{
  \begin{compactitem}
    ...
    \item Designed and developed the user interface using React.js, ensuring optimal performance across both desktop and mobile devices.
    \item Used Firebase for database management and user authentication.
  \end{compactitem}
}

\cventry{}{MCQuest \href{https://github.com/mc-quest/mc-quest}{\texttt{(GitHub)}}}{}{}{}{
  \begin{compactitem}
